...
* [Attention Is All You Need (1)](https://www.youtube.com/watch?v=iDulhoQ2pro)

## Quantum Computing
* [An introduction to quantum ML](https://arxiv.org/pdf/1409.3097.pdf)
* [Circuit Centric Quantum Classifier](https://arxiv.org/pdf/1804.00633.pdf)
* [Circuit for Shor's algorithm using 2n+3 qbits](https://arxiv.org/pdf/quant-ph/0205095.pdf)
* [Image Processing in Quantum Computers](https://arxiv.org/pdf/1812.11042.pdf)
* [Prospect and Chanllenges of Quantum Finance](https://arxiv.org/pdf/2011.06492.pdf)
* [quantum algorithm portfolio optimization](https://arxiv.org/pdf/1811.03975.pdf)
* [Quantum ML](https://arxiv.org/pdf/1611.09347.pdf)
* [Quantum supremacy using a programmable superconducting processor](https://www.nature.com/articles/s41586-019-1666-5.pdf)
* [Teleporting an unknown quantum state via dual classical and Einstein-Podolsky-Rosen channels](https://journals.aps.org/prl/pdf/10.1103/PhysRevLett.70.1895)
* [The Road to Quantum Artificial Intelligence](https://arxiv.org/ftp/arxiv/papers/0705/0705.3360.pdf)
* [What is actually teleported?](https://arxiv.org/pdf/quant-ph/0304158.pdf)

## Distributed Systems
* [lamport-part-time-parliament](https://courses.cs.washington.edu/courses/csep590/04wi/papers/lamport-part-time-parliament.pdf)
...
* [julia's drawings · julia's drawings](https://drawings.jvns.ca/)
* [Kill weasel words, avoid the passive, eliminate duplicates](http://matt.might.net/articles/shell-scripts-for-passive-voice-weasel-words-duplicates/)
* [Slower News](https://www.slowernews.com/)
* [Vim Blog](https://habamax.github.io/)

# Books
* [Computer Networks: A Systems Approach](https://book.systemsapproach.org/)
* [Real World OCaml](https://dev.realworldocaml.org/prologue.html)

# Documentation
* [ArchWiki](https://wiki.archlinux.org/)
* [Assistants’ Trove](https://assistants.epita.fr/doc/)
* [Competitive Programming Algorithms](https://cp-algorithms.com/)
* [Guidelines for ~/.vimrc](https://github.com/romainl/idiomatic-vimrc)
* [Programming Katas](https://github.com/emilybache/)
* [PySDR](https://pysdr.org/content/intro.html)
